...
import com.example.mypokedexapp.ui.pokedex.PokedexAdapter.PokemonViewHolder

class PokedexAdapter(private val imageLoader: ImageLoader) : ListAdapter<Pokemon, PokemonViewHolder>(PokemonCompacter()) {
